              ...
              <Card key={b.id}>
                ...
                <CardContent>
                  ...
                  <div className="flex gap-2">
                    <Button asChild size="sm"><Link href={`/tools/bounties/${b.id}`}>Manage</Link></Button>
                    <Button asChild size="sm" variant="outline"><Link href={`/tools/bounties/${b.id}`}>View</Link></Button>
                  </div>
                </CardContent>
              </Card>
            ))}
          ...
          {filtered.map((b) => (
            <Card key={b.id}>
              ...
              <CardContent>
                ...
                <div className="flex gap-2">
                  <Button asChild size="sm" variant="outline"><Link href={`/tools/bounties/${b.id}`}>Details</Link></Button>
