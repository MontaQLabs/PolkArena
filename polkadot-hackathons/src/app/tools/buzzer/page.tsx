    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-50 to-gray-100 dark:from-gray-900 dark:to-gray-800">
      <div className="container mx-auto px-4 py-6 sm:py-8 lg:py-12">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-6 lg:gap-8 mb-8 lg:mb-12 max-w-4xl mx-auto">
          {/* Create Room */}
          <Card className="border-2 border-storm-200 hover:border-polkadot-pink transition-all duration-300 group hover:shadow-lg">
            <CardHeader className="pb-4">
              <CardTitle className="flex items-center gap-3 text-lg sm:text-xl">
                <div className="p-2 bg-polkadot-pink/10 rounded-lg group-hover:bg-polkadot-pink/20 transition-colors">
                  <Plus className="h-5 w-5 text-polkadot-pink" />
                </div>
                Create New Room
              </CardTitle>
            </CardHeader>
            <CardContent className="pt-0">
              <Dialog open={isCreateDialogOpen} onOpenChange={setIsCreateDialogOpen}>
                <DialogTrigger asChild>
                  <Button className="w-full h-12 sm:h-14 bg-polkadot-pink hover:bg-polkadot-pink/90 text-base sm:text-lg font-semibold">
                    Create Room
                  </Button>
                </DialogTrigger>
                <DialogContent className="sm:max-w-md">
                  ...
                  <div className="space-y-4">
                    ...
                    <Button 
                      ...
                      className="w-full h-12 bg-polkadot-pink hover:bg-polkadot-pink/90 text-base font-semibold"
                    >
        ...
        <div className="max-w-6xl mx-auto">
          <div className="flex items-center gap-3 mb-6">
            ...
            <h2 className="text-xl sm:text-2xl font-semibold text-polkadot-pink">Available Rooms</h2>
          </div>
          
          {loading ? (
            <div className="text-center py-12">
              <div className="animate-spin rounded-full h-12 w-12 border-b-2 border-polkadot-pink mx-auto mb-4"></div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-4 sm:gap-6">
              {rooms.map((room) => (
                <Card key={room.id} className="border-2 border-storm-200 hover:border-polkadot-pink transition-all duration-300 group hover:shadow-lg">
                    ...
                    <Button 
                      ...
                      className={`w-full h-10 text-sm font-semibold ${
                        room.host_id === user?.id 
                          ? 'bg-polkadot-pink hover:bg-polkadot-pink/90' 
